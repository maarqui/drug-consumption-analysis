...
4. **Legal substances** show far higher recent use (Caffeine mode CL6 at 73.5%; Alcohol mode CL5 at 40.2%) than illegal ones (Heroin mode CL0 at 85.1%; Cocaine mode CL0 at 55.0%). ![[results/legal-illegal-comparison.png]]

5. **Sensation Seeking declines steadily with age** — from a mean of +0.40 in the 18–24 group to −0.97 in the 65+ group. ![[results/ss-age.png]]

6. **Outliers** are few in every personality score and plausibly represent genuine extremes; no removal is justified. ![[results/outlier-sigma.png]]
